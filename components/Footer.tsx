...
export default function Footer() {
  ...
  return (
    <>
      <footer className="w-full py-10 mt-auto bg-[var(--bg-elevated)] border-t border-[var(--border-default)] text-[var(--text-muted)] relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex-1 space-y-4 text-sm leading-relaxed">
            ...
            <div className="flex items-center gap-4 pb-4 border-b border-[var(--border-default)]">
              <button onClick={() => setPolicyType("terms")} className="hover:text-[var(--text-body)] transition-colors">이용약관</button>
              <div className="w-px h-3 bg-[var(--border-default)]"></div>
              <button onClick={() => setPolicyType("privacy")} className="hover:text-[var(--text-body)] transition-colors font-bold">개인정보처리방침</button>
              <div className="w-px h-3 bg-[var(--border-default)]"></div>
              <button onClick={() => setPolicyType("refund")} className="hover:text-[var(--brand-primary)] transition-colors font-bold">환불정책</button>
            </div>

            {/* 사업자 정보 */}
            <div className="space-y-2">
              <p className="font-semibold text-[var(--text-body)] text-base">플럭스미디어</p>
              ...
              <p className="mt-2">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-[var(--brand-primary)] hover:underline"
                >
                  <MessageCircle size={14} />
                  카카오톡 고객센터 문의하기
                </a>
              </p>
              <p className="text-xs text-[var(--text-muted)] mt-4">© 2024 FluxMedia. All rights reserved.</p>
            </div>
          </div>
      ...
      {policyType && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-[999] flex items-center justify-center p-5 animate-in fade-in">
          <div className="bg-[var(--bg-elevated)] border border-[var(--brand-primary)]/50 w-full max-w-md max-h-[80vh] rounded-3xl flex flex-col shadow-2xl relative overflow-hidden">
            <div className="p-5 border-b border-[var(--border-default)] flex justify-between items-center bg-[var(--bg-base)]">
              ...
              <button onClick={() => setPolicyType(null)} className="text-[var(--text-muted)] hover:text-[var(--text-body)] text-2xl leading-none">×</button>
            </div>
            
            <div className="p-5 overflow-y-auto flex-1 text-xs text-[var(--text-muted)] leading-relaxed whitespace-pre-wrap space-y-4">
              
              {/* 1. 이용약관 */}
              {policyType === "terms" && (
                <div className="space-y-4">
                  <p className="font-bold text-[var(--text-body)] mb-2">제1조 (목적)</p>
                  <p>본 약관은 플럭스미디어(이하 "회사")가 운영하는 웹사이트에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>

                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제2조 (정의)</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제3조 (약관의 명시와 개정)</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제4조 (서비스의 제공 및 변경)</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제5조 (이용권 구매 및 이용)</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제6조 (면책 조항)</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">제7조 (관할 법원)</p>
              ...
              {policyType === "privacy" && (
                <div className="space-y-4">
                  <p className="font-bold text-[var(--text-body)] mb-2">플럭스미디어(이하 "회사")는 「개인정보 보호법」 등 관련 법령을 준수하며, 정보주체의 개인정보 보호 및 권익을 보호하기 위해 다음과 같이 개인정보 처리방침을 두고 있습니다.</p>
                  
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">1. 수집하는 개인정보 항목 및 수집 방법</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">2. 개인정보의 수집 및 이용 목적</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">3. 개인정보의 제3자 제공 및 위탁</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">4. 개인정보의 보유 및 이용기간</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">5. 정보주체의 권리와 행사 방법</p>
                  <p>이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며, 동의 철회 및 가입 해지(탈퇴)를 요청할 수 있습니다.</p>
                  
                  <p className="font-bold text-[var(--text-body)] mt-4 mb-2">6. 개인정보 보호책임자</p>
              ...
              {policyType === "refund" && (
                <div className="space-y-4">
                  <p className="font-bold text-[var(--brand-primary-hover)] text-sm mb-3">⚠️ 이용권 유효기간 및 환불 규정</p>
                  
                  <p className="font-bold text-[var(--text-body)] mb-2">1. 유효기간</p>
                  ...
                  <p className="font-bold text-[var(--text-body)] mb-2">2. 전액 환불</p>
                  <ul className="list-disc pl-4 mb-4 space-y-1">
                    <li>결제일로부터 7일 이내에, 이용권을 단 1회도 사용하지 않은 미사용 건에 한하여 100% 전액 환불됩니다.</li>
                  </ul>

                  <p className="font-bold text-[var(--text-body)] mb-2">3. 부분 환불 및 위약금</p>
                  <ul className="list-disc pl-4 mb-4 space-y-1">
                    <li>결제일로부터 7일이 경과하였거나, 이용권을 1회 이상 사용한 후 중도 해지 및 환불을 요청하실 경우 아래 기준에 따라 정산 후 환불됩니다.</li>
                    <li className="text-[var(--brand-primary)] font-bold mt-2 mb-2 bg-[var(--brand-primary)]/10 p-2 rounded">
                      환불 금액 = 실제 결제 금액 - (사용한 횟수 × 1회권 정상가) - 위약금(결제 금액의 10%)
                    </li>
                    <li>다회권(3회권, 10회권 등)의 부분 환불 시, 적용된 할인가가 아닌 <strong className="text-[var(--text-body)]">'1회권 정상가'</strong>를 기준으로 사용 금액이 공제됩니다.</li>
                    <li>공제 금액의 총합(사용분 정상가 + 위약금)이 실제 결제 금액과 같거나 초과할 경우 잔여 환불금이 발생하지 않으므로 환불이 불가합니다.</li>
                  </ul>

                  <p className="font-bold text-[var(--text-body)] mb-2">4. 기타 예외 사항</p>
                  <ul className="list-disc pl-4 mb-4 space-y-1">
            ...
            <div className="p-4 bg-[var(--bg-base)]">
              <button onClick={() => setPolicyType(null)} className="w-full py-3 bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated-alt)] text-[var(--text-muted)] rounded-xl font-bold transition-colors">
                확인했습니다
              </button>
            </div>
          </div>
